...
async def cmd_help(update:Update,context:ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "👑 *کامندهای ادمین:*\n\n"
        "━━ 🚫 کاربران ━━\n/ban <id> | /unban <id> | /kick <id>\n/players | /playerinfo <id>\n\n"
        "━━ 💰 دارایی ━━\n/setbudget <id> <مقدار>\n/addbudget <id> <مقدار>\n/setoil <id> <مقدار>\n"
        "/addequip <id> <item_id>\n/removeequip <id> <item_id>\n/equiplist\n\n"
        "━━ 🔄 ریست ━━\n/resetplayer <id> | /resetall confirm\n\n"
        "━━ ⚙️ کنترل ━━\n/toggle → نمایش وضعیت\n/toggle shop|decl|war|trade\n\n"
        "━━ 📢 ارتباط ━━\n/broadcast <پیام> | /adminstats | /adminhelp",
        parse_mode="Markdown")
...
def main():
    ...
    for cmd,fn in [("start",start),("ban",cmd_ban),("unban",cmd_unban),("kick",cmd_kick),
                   ...
                   ("addequip",cmd_addequip),("removeequip",cmd_removeequip),("equiplist",cmd_equiplist),
                   ("playerinfo",cmd_playerinfo),("toggle",cmd_toggle),("resetplayer",cmd_resetplayer),
                   ("resetall",cmd_resetall),("broadcast",cmd_broadcast),("adminhelp",cmd_help),
